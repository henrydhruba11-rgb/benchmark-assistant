...
1. **目标与受众**:测 LLM 还是 agent?为谁、发布还是内部用?(受众推断已在启动时完成,此步沿用其结论;若发现推断偏差则修正)
...
同时从用户首句话推断熟练度(熟练/中级/新手),据此调术语解释深度与节奏;模糊时主动确认(如"我先按你熟悉 Pass@k 来讲,需要展开吗?")。受众推断在启动时一次性完成,后续模式沿用其结论。
...
- skill 唤起后展示三选一菜单,并能据用户首句话推断受众、调整语气;
